...
const caseStudies = [
  {
    industry: 'E-Commerce',
    client: 'Belladona by Farin',
    headline: '92% increase in organic traffic in 90 days',
  ...
  {
    industry: 'FMCG',
    client: 'Maze Fragrance',
    headline: '80% ROI on influencer campaign in 30 days',
    description: 'Multi-channel influencer strategy across Instagram and TikTok. 4.2 million impressions, 180K new brand followers, and an 80% return on campaign investment.',
